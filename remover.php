...
if ($conn->query($sql) === TRUE) {
    echo "<div class='max-w-3xl mx-auto p-8 bg-green-100 rounded-lg shadow-lg mt-10 text-center'>
            ...
            <div class='space-x-4'>
                <button type='button' onclick=\"window.location.href='listar.php'\" class='px-6 py-2 text-white bg-indigo-600 font-semibold rounded-lg shadow-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500'>
                    Voltar para a lista
                </button>
            </div>
          </div>";

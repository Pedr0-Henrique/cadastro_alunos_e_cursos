...
$sql = "UPDATE alunos SET nome = ?, email = ?, data_nascimento = ?, curso_id = ?, data_inicio = ? WHERE id = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("sssisi", $nome, $email, $data_nascimento, $curso_id, $data_inicio, $id);
